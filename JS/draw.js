var canvas = document.getElementById('canvas');
        ...
        bamboo.src = './IMG/Bamboof.jpg';
        var grass = new Image();
        grass.src = './IMG/Grassf.png'; 
        var shinobi = new Image();
        shinobi.src = './IMG/Shinobi.png';
        var shinobi0 = new Image();
        shinobi0.src = './IMG/Shinobi_0.png';
        var shinobic = new Image();
        shinobic.src = './IMG/Shinobi_c.png';
        var enemy = new Image();
        enemy.src = './IMG/Enemy.png';
        var bam_hit = new Image();
        bam_hit.src = './IMG/Bamboo_hit.png';
        var spear = new Image();
        spear.src = './IMG/SpikesT.png';
        var menu = new Image();
